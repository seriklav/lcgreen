...
use app\models\query\DailyMoneyQuery;
use Yii;
use yii\behaviors\TimestampBehavior;
use yii\helpers\ArrayHelper;

/**
 * This is the model class for table "{{%daily_money}}".
 *
 * @property int $id
 ...
 */
class DailyMoney extends \yii\db\ActiveRecord
{
    ...
    /**
     * {@inheritdoc}
     * @return DailyMoneyQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new DailyMoneyQuery(get_called_class());
    }
