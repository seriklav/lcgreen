...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <?php  if($support->who == -1) echo 'Техподдержка'; else echo $support->who; ?>
            </div>
            <div class="card-body">
        ...
        <?php if(!is_null($dialog)): ?>
            <?php foreach($dialog as $d): ?>
                <div class="card" <?php if($d->who == -1) echo 'style="text-align: right;"'; ?>>
                    <div class="card-header">
    ...
    <?php $form = ActiveForm::begin(['id' => 'support']); ?>
    <div class="form-group">
        <label for="comment">Сообщение:</label>
        <?= $form->field($model, 'message')->textarea(['rows' => '6'])->label(false) ?>
    </div>
    <button type="submit" class="btn btn-primary btn-lg" style="display: block; margin: auto;">Отправить</button>
    </div>
    <?php ActiveForm::end(); ?>
</div>
