...
?>
    ...
    <div class="tab-cont active">
        ...
        <div class="tab-content secondary ">
            ...
            <!--            --><?//= $this->render('./daily-money/tab-1') ?>
            <!--        </div>-->
            <div id="tab2" class="tab-cont active">
                <?= $this->render('./daily-money/tab-2', [
                    'model' => $model,
                    'dailyes' => $dailyes,
                    'clones' => $clones,
                    'step_name' => $step_name,
...
var dialog = $( "#dialog-form" ).dialog({
    ...
    $('body').on('click', '.tab-content #step1 .cycle',  function(e) {
    ...
    $('.tab-content #program-daily-money .cycle').on('click',function() {
              if(!$(this).data('cycle')) {
                  if($(this).data('clone')) {
