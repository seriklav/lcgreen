                    ...
                    <div class="string flex centered vert-start wrap">
                        <?php for($i = 0; $i < 4; $i++){ ?>
                            <div class="cycle" data-cycle="<?php echo $i; ?>">
                                ...
                                <?php if(is_null(Step::findOneNotDaily(['owner_id' => Yii::$app->user->identity->id,'step' => $i]))): ?>  <div class="summ"> <?php echo $step_price[$i]; ?> </div> <?php else: echo '<span class="have"></span>'; ?> <?php endif; ?>
                            </div>
                        <?php } ?>
                    </div>
                    <div class="string flex centered vert-start wrap">
                    ...
                    if($loop == 2):
                        ...
                        for($i = $loop; $i < $step_place[Yii::$app->user->identity->step_mon] - 1; $i++){ ?>
                            <div class="block-logo">
                                ...
                                {
                                    $minus = 2;
                                    $seven_step = Step::findOneNotDaily([
                                        'owner_id' => $seven[0],
                                        'status' => 0,
...
if(\app\commands\MyClass::myIp()) {
    $url = URL::to(['/user/monitoring-old']);
}
$js = <<<JS
